...
sensor.prototype =
{
  enable: function()
  {
    ...
    const c1 = this._i2c.writeAndReadBytes([ BME280.DIG_H2 ], 16);
    this._dig =
    {
      T1: onec(c0[1], c0[0]),
      T2: twoc(c0[3], c0[2]),
    ...
    // Configure
    this._i2c.writeBytes([ BME280.CTRL_HUM, 0x01 ]); // 1x oversampling
  ...
  _getRawData: function()
  {
    ...
    else
    {
      ...
      const data = this._i2c.writeAndReadBytes([ BME280.PRESSURE ], 8);
